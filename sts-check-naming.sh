...
grep -r dd-agent . | grep -v dd-agent-testing | grep -v README | grep -v CONTRIBUTING | grep -v appveyor | grep -v dd-agent/wiki | grep -v dd-agent/issues | grep -v .git/config | grep -ve ".py:\\s*#" | grep -v sts-check-naming | grep -v Binary | grep -v git/logs | grep -v CHANGELOG | grep -ve "^./ci/" | grep -v smartos | grep -v win32 | grep -v osx | grep -v blah | grep -v /source/ | grep -ve "^./tests" | grep -v git/logs
...
grep -r datadoghq.com . | grep -v sts-check-naming | grep -v CHANGELOG | grep -ve "^./ci/" | grep -v centos | grep -v "/source/" | grep -v win32 | grep -ve "^./tests/" | grep -v README | grep -v CONTRIBUTING | grep -v LICENSE
