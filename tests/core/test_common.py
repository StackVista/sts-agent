...
class TestCore(unittest.TestCase):
    ...
    def test_announce_topology_data(self):
        ...
        self.assertEquals(len(self.c._topology_components_store), 1)
        self.assertEquals(len(self.c._topology_relations_store), 0)
        ...
        self.assertEquals(self.c._topology_components_store[0], expected_component_1)

        self.c.announce_component("test-component2", "test-component2", "container", 1298066183.607717, "desc", ['tag3', 'tag4'])
        self.assertEquals(len(self.c._topology_components_store), 2)
        self.assertEquals(len(self.c._topology_relations_store), 0)
        ...
        self.assertEquals(self.c._topology_components_store[1], expected_component_2)

        self.c.announce_relation("test-component1", "test-component2", "dependsOn")
        self.assertEquals(len(self.c._topology_components_store), 1)
        self.assertEquals(len(self.c._topology_relations_store), 2)
        ...
        self.assertEquals(self.c._topology_relations_store[0], expected_relation)
